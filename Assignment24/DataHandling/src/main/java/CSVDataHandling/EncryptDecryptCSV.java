...
public class EncryptDecryptCSV {
    ...
    public static void writeCSV(String csvFilePath) {
        String[][] data = {
                ...
                {"201", "Rohan Mehta", "rohan.mehta@example.com", "90000"},
                {"202", "Ananya Sharma", "ananya.sharma@example.com", "85000"},
                {"203", "Aryan Gupta", "aryan.gupta@example.com", "78000"},
                {"204", "Meera Kapoor", "meera.kapoor@example.com", "95000"},
                {"205", "Kabir Verma", "kabir.verma@example.com", "72000"}
        };
