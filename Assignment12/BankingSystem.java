...
public class BankingSystem {
    ...
    public static void main(String[] args) {
        SavingsAccount savingsAccount = new SavingsAccount("SA123", "Krishna", 10000, 5);
        CurrentAccount currentAccount = new CurrentAccount("CA123", "Nitin", 2000);
        PersonalLoanAccount loanAccount = new PersonalLoanAccount("LA123", "Gopal", 8000, 4);
