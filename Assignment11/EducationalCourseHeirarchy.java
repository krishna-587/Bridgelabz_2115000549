...
public class EducationalCourseHeirarchy {
    public static void main(String[] args) {
        ...
        Course onlineCourse = new OnlineCourse("Introduction to Java", 6 , "Coursera", true);
        Course  paidCourse  = new PaidOnlineCourse("Javascript", 2, "Coding blocks", true, 12.99, 25);
