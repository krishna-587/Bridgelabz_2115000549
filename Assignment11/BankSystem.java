...
public class BankSystem {
    public static void main(String[] args) {
        SavingsAccount savings = new SavingsAccount("CV9045", 2000.0, 4.5);
        CheckingAccount checking = new CheckingAccount("JK9456", 8000.0, 10.0);
        FixedDepositAccount fixedDeposit = new FixedDepositAccount("KJ5687", 60000.0, 34);
